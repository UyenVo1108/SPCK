  ...
  .then((data) => {
    ...
    function showdata(data) {
        ...
        data.forEach((item) => {
            ...
            <img data-id="${item.id}" src="${item.image}" class="product-image img ounded-3" alt="..." height="280" />
            <div class="card-body p-2 d-flex flex-column gap-2">
            <h5 class="card-title p-0">${item.name}</h5>
            <div class="review d-flex gap-1">
            <ion-icon class="text-warning" name="star"></ion-icon>
            <ion-icon class="text-warning" name="star"></ion-icon>
            <ion-icon class="text-warning" name="star"></ion-icon>
            <ion-icon class="text-warning" name="star"></ion-icon>
            <ion-icon class="text-warning" name="star-half"></ion-icon>
            </div>
            <input type="hidden" class="category" name="" value="${item.category}">
            <div class="price d-flex gap-1">
            <div class="price-new">
            <span class="fs-6  price-sale fw-medium">${item.price.toLocaleString()} VND</span>
            </div>
            <div class="">
            <del class="fs-6 fw-medium price-old text-secondary">${item.priceOld.toLocaleString()} VND</del>
            </div>
            </div>
            <div class="button-product">
            <button  class=" addcart btn btn-success text-white fw-medium"
            >Mua Hàng</
            > 
            ...
            <div
            class="sale position-absolute top-0 end-0 rounded-4 bg-danger bg-opacity-75 shadow-sm"
            >
            <span class="text-white p-2 fw-semibold">Sale</span>
            </div>
            </div>
            </div>
            `
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="modal-cart-qty text-center mt-1">
            <div
              class="modal-cart-qty-plus-minus border rounded-2 m-0 d-flex align-items-center justify-content-center border-0"
            >
              <button type="button" class="addValueQuatity">
                <ion-icon class="fs-4" name="add-outline"></ion-icon>
              </button>
              <input
                type="text"
                name=""
              ...
              <button type="button" class="minusValueQuatity">
                <ion-icon class="fs-4" name="remove-outline"></ion-icon>
              </button>
            </div>
          </div>
        </div>
